...
- **On-chain**
  - An airdrop pallet(substrate pallet)
    ...
    - Cancel airdrop
    - Increase airdrop staked amount
    - Claim airdrop (can be claimed for anyone)
    - Delete on-chain airdrop information
  - An airdrop pallet (ink contract)
    - Set airdrop: Merkle root, MD5 hash, start date, end date, total airdrop amount (must be staked)
    - Cancel airdrop
    - Increase airdrop staked amount
    - Claim airdrop (can be claimed for anyone)
    - Delete on-chain airdrop information
...
| 3. | web server | To facilitate users in claiming airdrops, a centralized web service is allowed for airdrop providers. This web service offers the same functionality as the PC application. |
